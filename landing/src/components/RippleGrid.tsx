...
type UniformValue = {
  value: boolean | number | [number, number] | [number, number, number];
};

type UniformMap = {
  iTime: UniformValue;
  iResolution: UniformValue;
  enableRainbow: UniformValue;
  gridColor: UniformValue;
  rippleIntensity: UniformValue;
  gridSize: UniformValue;
  gridThickness: UniformValue;
  fadeDistance: UniformValue;
  vignetteStrength: UniformValue;
  glowIntensity: UniformValue;
  opacity: UniformValue;
  gridRotation: UniformValue;
  mouseInteraction: UniformValue;
  mousePosition: UniformValue;
  mouseInfluence: UniformValue;
  mouseInteractionRadius: UniformValue;
};
...
void main() {
    ...
    const render = (time: number) => {
      ...
      uniforms.mouseInfluence.value = nextInfluence;
