export function loadConfig() {
  ...
  return {
    ...
    selfAgentId: process.env.SELF_AGENT_ID,
    selfAgentAddress: process.env.SELF_AGENT_ADDRESS,
    selfVerificationStatus: process.env.SELF_VERIFICATION_STATUS,
    selfVerificationUrl: process.env.SELF_VERIFICATION_URL,
